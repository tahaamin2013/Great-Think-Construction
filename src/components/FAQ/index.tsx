...
const faqs = [
  ...
  },
  {
    ...
    answer: "The main phases typically include planning, design, pre-construction, construction, and post-construction. Each phase is crucial for the successful completion of the project."
  },
  {
    question: "How do I choose the right contractor for my project?",
    answer: "Consider factors such as experience, references, licensing, insurance, and communication skills when selecting a contractor. It's also important to get multiple bids and thoroughly review contracts before making a decision."
  },
];
  ...
  return (
    <div className="bg-zinc-900 my-5 text-white p-6 md:p-12 rounded-3xl flex md:flex-row flex-col gap-8 md:gap-12">
      <div className="w-full md:w-1/2">
        <div className="mb-4">
          <span className="bg-yellow-500 text-black text-xs font-bold py-1 px-3 rounded-full">FAQ</span>
        </div>
        ...
        <Accordion type="single" collapsible className="w-full">
          {faqs.map((faq, index) => (
            <AccordionItem key={index} value={`item-${index}`} className="mb-4 border-none">
